        ...
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="col-12 col-md-8">
                    <div class="message-info d-flex align-items-center">
                        <img src="{{ asset('images/fotodesi.jpeg') }}" alt="Profile" class="profile-img rounded-circle"
                            width="50" height="50">
            ...
            <div class="message-card mt-4">
                <div class="message-body">
                    ...
                    <p>Saya Desi Maya Sari dari Prodi Teknik Informatika ingin melakukan bimbingan KRS. Karena itu,
                        apakah ibu ada di kampus?</p>
