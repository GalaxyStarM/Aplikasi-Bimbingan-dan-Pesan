...
<body>
    ...
    <div class="content container">
        ...
        <hr>
        <button class="btn btn-success mb-4" onclick="window.location.href='{{ route('masukkanjadwal') }}'">+ Masukkan
            Jadwal Bimbingan</button>

        <div class="card">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="usulan-tab" data-bs-toggle="tab" href="#usulan"
                            role="tab">Usulan Bimbingan (2)</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="jadwal-tab" data-bs-toggle="tab" href="#jadwal" role="tab">Daftar
                            Jadwal (0)</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="riwayat-tab" data-bs-toggle="tab" href="#riwayat" role="tab">Riwayat
                            (0)</a>
                    </li>
                </ul>
            </div>
                ...
                <div class="tab-pane fade" id="riwayat" role="tabpanel">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="8" class="text-center">Belum ada riwayat Bimbingan</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
